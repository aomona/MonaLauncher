  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "アカウント認証の仲介",
        description:
          "実アクセストークンをゲームへ渡さず、ランチャーが認証を仲介します。初期設定はOFFです。ONの間はすべてのModも許可された認証操作を利用できます。ログインと通信許可が必要で、デモ・未ログイン時は仲介しません。現在は1.21.8・26.2の試験対応です。チャット署名の秘密鍵もゲームへ渡しません。実アカウントでのオンライン接続はmacOSで検証済み、Windows・Linuxでは未検証です。",
      },
      {
        key: "audioOutput",
        label: "通常音声",
